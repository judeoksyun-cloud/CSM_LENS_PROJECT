...
assert.match(html, /id="peer-trend-chart"/, "trend page should include one nine-company relative trend chart");
...
assert.match(script, /function renderPeerTrendChart\(/, "dashboard should render the nine-company relative trend chart");
assert.match(script, /point\.closing \/ context\.period\.csm - 1/, "peer chart should normalize each company to its latest actual CSM");
