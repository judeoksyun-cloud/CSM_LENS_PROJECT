  ...
  "forecasts": {
    "samsung-life": {
      ...
      "base": {
        ...
        "targetAdjustmentOverlay": -635,
        "adjustmentOverlayBasis": "경영목표와 독립 모델 차이를 CSM 조정 등에 포함",
        "rationale": "사용자 제공 2026년말 CSM 목표 13.5조원을 경영계획 Base로 적용했습니다. 독립 Driver 모델 대비 -0.635조원 차이를 CSM 조정 등에 포함했습니다."
      },
      "worst": {
        "opening": 13218,
        "newbiz": 3159,
        ...
        "quarters": [
          ...
          },
          {
            ...
            "amortization": -363,
            "closing": 12346,
            "adjustmentBeforeTargetOverlay": -984,
            "targetAdjustmentOverlay": -635
          }
        ],
        "remainingForecast": {
          ...
          "adjustmentBeforeTargetOverlay": -2252,
          "targetAdjustmentOverlay": -635
        },
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "modelClosing": 12981,
        "adjustmentBeforeTargetOverlay": -2432,
        "targetAdjustmentOverlay": -635,
        "adjustmentOverlayBasis": "경영목표와 독립 모델 차이를 CSM 조정 등에 포함",
        "rationale": "신계약 판매 둔화와 계약당 수익성 저하가 나타나고, 해지·비용 관련 CSM 조정 부담도 함께 커지는 경우를 반영한 Worst입니다. CSM 조정 부담에는 장래손해율 상승, 해지 증가 및 사업비 가정 악화를 포함하며, 1분기 확정 실적은 낮추지 않았습니다."
      },
      "independentModel": {
        "base": {
          "opening": 13218,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.14235,
          "worstAdjustmentDownsideRateToOpening": 0.058056,
        ...
        "executiveRationale": {
          "years1to3": "2026년은 사용자 제공 CSM 목표 13.5조원을 경영계획 Base로 적용하고 독립 모델 전망을 병렬 공개. Worst는 같은 목표를 출발점으로 신계약 판매 둔화와 장래손해율·해지·비용 가정 악화에 따른 CSM 조정 부담을 반영하고, 2027~2028년은 정상화 Movement로 계산",
          "year5": "과거 신계약 추세를 연 -3.0% 범위로 적용하고 2026년 CSM 조정률을 유지해 2030년까지 Movement를 연결",
          "year10": "2035년 Base는 신계약 증가율 연 -1.0%와 현재 CSM 조정률을 적용하고, Worst는 동일한 백테스트 스트레스 원칙을 장기 경로에 적용"
        },
        "horizonConfidence": {
          "oneYear": "제한적 검증",
      ...
      "qualitativeJudgment": {
        ...
        "baseAdjustment": "통상적인 경험조정과 연말 계리 가정 재점검 부담을 구분해 반영. 현재 해지 흐름이 안정화된 점을 감안하되 연말 변동 가능성을 남겨 잔여 모델 조정 -1.46조원 적용. 참고: 13.5조원 목표 정합화를 위한 -0.64조원을 CSM 조정 등에 포함.",
        "targetAdjustmentOverlay": "경영계획 Base 13.50조원과 독립 모델 14.13조원의 차이 -0.64조원. CSM 조정 등에 포함.",
        "worst": "신계약 판매 둔화와 계약당 수익성 저하가 나타나고, 해지·비용 관련 CSM 조정 부담도 함께 커지는 경우를 반영한 Worst입니다. CSM 조정 부담에는 장래손해율 상승, 해지 증가 및 사업비 가정 악화를 포함하며, 1분기 확정 실적은 낮추지 않았습니다."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
      ...
      "evidenceProfile": {
        "rating": "입력 검증 필요",
        "directAnalystSourceCount": 1,
        "officialActual": true,
        "anchorVerificationStatus": "unverified",
        "categories": [
          "확정 사실",
          "외부 전망",
          "모델 추정",
        ...
        "newbiz": {
          ...
          "items": [
            ...
            },
            {
              "kind": "control",
              "label": "외부 보정 통제",
              "headline": "회사별 직접 리포트 미확인·외부 보정 0%",
              "detail": "업종 공통 자료는 방향성 참고에만 사용하고 회사 전망 숫자에는 반영하지 않음",
              "sourceId": "samsung-life-forecast-methodology"
            }
          ]
        },
      ...
      "driverForecast": {
        ...
        "distribution": {
          "p10": {
            ...
            "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
            "label": "Worst",
            "description": "신계약 판매가 예상보다 둔화되고 장래손해율·해지·비용 가정 악화로 CSM 조정 부담까지 함께 커지는 경우",
            "modelClosing": 12981,
            "adjustmentBeforeTargetOverlay": -2432,
            "targetAdjustmentOverlay": -635,
            "adjustmentOverlayBasis": "경영목표와 독립 모델 차이를 CSM 조정 등에 포함"
        ...
        "movementEvidence": {
          ...
          "adjustment": {
            "statement": "해지 흐름 안정화와 연말 계리 가정 재점검 부담을 반영. 참고: 13.5조원 목표 정합화를 위한 -0.64조원을 CSM 조정 등에 포함",
            "items": [
              {
                "kind": "actual",
                "label": "확정 실적",
              ...
              },
              {
                ...
                "detail": "잔여 조정 -1.460조원을 반복 경험조정 -0.388조원과 연말 가정 재점검 예비분 -1.072조원으로 구분. 여기에 13.5조원 목표 정합화를 위한 -0.635조원을 추가해 연간 CSM 조정 등에 포함",
                "sourceId": "csm-forecast-methodology"
              }
            ]
          },
        ...
        "stressScenarios": {
          "salesSlowdown": {
            ...
            "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
            "label": "판매 둔화",
            "description": "판매량 또는 상품 수익성이 예상보다 낮아 신계약 CSM 창출력이 약해지는 경우",
            "modelClosing": 13764,
            "adjustmentBeforeTargetOverlay": -1640,
            "targetAdjustmentOverlay": -635,
            "adjustmentOverlayBasis": "경영목표와 독립 모델 차이를 CSM 조정 등에 포함"
          ...
          "marginCompression": {
            ...
            "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
            "label": "수익성 압박",
            "description": "판매 규모는 유지되지만 상품 믹스와 마진이 나빠져 계약당 CSM이 낮아지는 경우",
            "modelClosing": 13950,
            "adjustmentBeforeTargetOverlay": -1640,
            "targetAdjustmentOverlay": -635,
            "adjustmentOverlayBasis": "경영목표와 독립 모델 차이를 CSM 조정 등에 포함"
          ...
          "lapseAndExpense": {
            ...
            "description": "판매는 계획대로 진행되지만 장래손해율 상승, 해지 증가 또는 사업비 가정 악화로 CSM 조정 부담이 커지는 경우",
            "modelClosing": 13351,
            "adjustmentBeforeTargetOverlay": -2432,
            "targetAdjustmentOverlay": -635,
            "adjustmentOverlayBasis": "경영목표와 독립 모델 차이를 CSM 조정 등에 포함"
          ...
          "combined": {
            ...
            "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
            "label": "복합 스트레스",
            "description": "신계약 CSM 창출력 약화와 장래손해율·해지·비용 가정 악화가 동시에 발생하는 Worst 복합 경로",
            "modelClosing": 12981,
            "adjustmentBeforeTargetOverlay": -2432,
            "targetAdjustmentOverlay": -635,
            "adjustmentOverlayBasis": "경영목표와 독립 모델 차이를 CSM 조정 등에 포함"
    ...
    "hanwha-life": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 14.6% 낮추고, 기시 CSM의 5.9%를 추가 조정 부담으로 반영. 조정은 Base -1.28조원에서 Worst -1.81조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 8714,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.146289,
          "worstAdjustmentDownsideRateToOpening": 0.059435,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
        "executiveRationale": {
          "years1to3": "최근 분기 실적과 전년 계절성으로 Base를 산출하고, 증권사 근거가 있는 회사만 제한적으로 반영. Worst는 회사별 6개·업권별 24개 롤링 검증 시점의 오차를 계층 보정",
          "year5": "과거 신계약 추세를 연 -3.0% 범위로 적용하고 2026년 CSM 조정률을 유지해 2030년까지 Movement를 연결",
          "year10": "2035년 Base는 신계약 증가율 연 -1.0%와 현재 CSM 조정률을 적용하고, Worst는 동일한 백테스트 스트레스 원칙을 장기 경로에 적용"
        },
        "horizonConfidence": {
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 14.6% 낮추고, 기시 CSM의 5.9%를 추가 조정 부담으로 반영. 조정은 Base -1.28조원에서 Worst -1.81조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
      ...
      "evidenceProfile": {
        ...
        "directAnalystSourceCount": 1,
        "officialActual": true,
        "anchorVerificationStatus": "not_applicable",
        "categories": [
          "확정 사실",
          "외부 전망",
          "모델 추정",
        ...
        "newbiz": {
          ...
          "items": [
            ...
            },
            {
              "kind": "analyst",
              "label": "애널리스트 반영",
              "headline": "회사별 직접 리포트 25% 반영",
              "detail": "CSM 배수 상승과 신계약 CSM 0.61조원을 Base에 반영",
              "sourceId": "hanwha-life-analyst-1"
            }
          ]
        },
        "interest": {
          ...
          "items": [
            ...
            },
            {
              "kind": "model",
              "label": "산출식",
              "headline": "2026년 연간 이자부리 +0.363조원",
              "detail": "분기 이자부리율 0.95%를 기시 CSM과 신계약 CSM 합계에 적용",
              "sourceId": "hanwha-life-forecast-methodology"
            }
          ]
        },
    ...
    "kyobo-life": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 16.9% 낮추고, 기시 CSM의 7.5%를 추가 조정 부담으로 반영. 조정은 Base -0.31조원에서 Worst -0.81조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 6511,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.169236,
          "worstAdjustmentDownsideRateToOpening": 0.074527,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 16.9% 낮추고, 기시 CSM의 7.5%를 추가 조정 부담으로 반영. 조정은 Base -0.31조원에서 Worst -0.81조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
    ...
    "shinhan-life": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 23.0% 낮추고, 기시 CSM의 6.1%를 추가 조정 부담으로 반영. 조정은 Base -0.61조원에서 Worst -1.08조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 7450,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.229567,
          "worstAdjustmentDownsideRateToOpening": 0.061252,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
        "executiveRationale": {
          ...
          "year10": "2035년 Base는 신계약 증가율 연 +2.0%와 현재 CSM 조정률을 적용하고, Worst는 동일한 백테스트 스트레스 원칙을 장기 경로에 적용"
        },
        "horizonConfidence": {
          "oneYear": "제한적 검증",
          "twoToThreeYears": "모델 경로",
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 23.0% 낮추고, 기시 CSM의 6.1%를 추가 조정 부담으로 반영. 조정은 Base -0.61조원에서 Worst -1.08조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
    ...
    "samsung-fire": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 22.8% 낮추고, 기시 CSM의 7.2%를 추가 조정 부담으로 반영. 조정은 Base -1.44조원에서 Worst -2.48조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 14168,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.227862,
          "worstAdjustmentDownsideRateToOpening": 0.0718,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
        "executiveRationale": {
          "years1to3": "최근 분기 실적과 전년 계절성으로 Base를 산출하고, 증권사 근거가 있는 회사만 제한적으로 반영. Worst는 회사별 6개·업권별 30개 롤링 검증 시점의 오차를 계층 보정",
          "year5": "과거 신계약 추세를 연 -3.0% 범위로 적용하고 2026년 CSM 조정률을 유지해 2030년까지 Movement를 연결",
          "year10": "2035년 Base는 신계약 증가율 연 -1.0%와 현재 CSM 조정률을 적용하고, Worst는 동일한 백테스트 스트레스 원칙을 장기 경로에 적용"
        },
        "horizonConfidence": {
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 22.8% 낮추고, 기시 CSM의 7.2%를 추가 조정 부담으로 반영. 조정은 Base -1.44조원에서 Worst -2.48조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
    ...
    "meritz-fire": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 24.2% 낮추고, 기시 CSM의 6.7%를 추가 조정 부담으로 반영. 조정은 Base -0.16조원에서 Worst -0.92조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 11102,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.24187,
          "worstAdjustmentDownsideRateToOpening": 0.067137,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 24.2% 낮추고, 기시 CSM의 6.7%를 추가 조정 부담으로 반영. 조정은 Base -0.16조원에서 Worst -0.92조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
    ...
    "db-insurance": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 25.4% 낮추고, 기시 CSM의 5.7%를 추가 조정 부담으로 반영. 조정은 Base -1.80조원에서 Worst -2.53조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 12205,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.254269,
          "worstAdjustmentDownsideRateToOpening": 0.057173,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
        "executiveRationale": {
          ...
          "year10": "2035년 Base는 신계약 증가율 연 +0.0%와 현재 CSM 조정률을 적용하고, Worst는 동일한 백테스트 스트레스 원칙을 장기 경로에 적용"
        },
        "horizonConfidence": {
          "oneYear": "제한적 검증",
          "twoToThreeYears": "모델 경로",
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 25.4% 낮추고, 기시 CSM의 5.7%를 추가 조정 부담으로 반영. 조정은 Base -1.80조원에서 Worst -2.53조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
      ...
      "sources": [
        {
          ...
          "type": "sell_side",
          "use": "보장성 매출과 신계약 CSM 감소 전망을 25% 애널리스트 오버레이에 반영",
        ...
        "newbiz": {
          ...
          "items": [
            ...
            },
            {
              ...
              "label": "애널리스트 반영",
              "headline": "회사별 직접 리포트 25% 반영",
              "detail": "보장성 매출과 신계약 CSM 감소 전망을 25% 애널리스트 오버레이에 반영",
              "sourceId": "db-insurance-analyst-1"
            }
          ]
        },
        "interest": {
    ...
    "hyundai-marine": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 26.2% 낮추고, 기시 CSM의 7.5%를 추가 조정 부담으로 반영. 조정은 Base -1.16조원에서 Worst -1.85조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 8978,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.262101,
          "worstAdjustmentDownsideRateToOpening": 0.074954,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 26.2% 낮추고, 기시 CSM의 7.5%를 추가 조정 부담으로 반영. 조정은 Base -1.16조원에서 Worst -1.85조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
        ...
        "newbiz": {
          ...
          "items": [
            ...
            },
            {
              ...
              "label": "애널리스트 반영",
              "headline": "회사별 직접 리포트 25% 반영",
              "detail": "예실차 개선과 연간 장기 위험손해율 전망을 Base 조정에 반영",
              "sourceId": "hyundai-marine-analyst-1"
            }
          ]
        },
        "interest": {
    ...
    "kb-insurance": {
      ...
      "worst": {
        ...
        "movementBasis": "2025년말 기시 · 2026.1Q 실적 + 2026.2Q~4Q 전망",
        "rationale": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 22.7% 낮추고, 기시 CSM의 5.9%를 추가 조정 부담으로 반영. 조정은 Base -0.82조원에서 Worst -1.38조원으로 적용."
      },
      "independentModel": {
        "base": {
          "opening": 9285,
      ...
      "horizon": {
        ...
        "assumptions": {
          ...
          "worstNewbizStress": 0.227344,
          "worstAdjustmentDownsideRateToOpening": 0.059159,
          "stressCalibrationQuantile": 0.8,
          "stressCalibrationSampleCount": 6,
          "longTermMethod": "2030년 Base와 Worst를 각각 앵커로 유지해 2035년 Base와 Worst를 산출"
        },
      ...
      "qualitativeJudgment": {
        ...
        "targetAdjustmentOverlay": "목표 정합화 조정 없음",
        "worst": "과거 Q1 시점 연말 예측 오차의 80백분위로 신계약 CSM을 Base 대비 22.7% 낮추고, 기시 CSM의 5.9%를 추가 조정 부담으로 반영. 조정은 Base -0.82조원에서 Worst -1.38조원으로 적용."
      },
      "confidence": "검증 제한",
      "validation": {
        "label": "검증 제한",
